      ...
      <div className="mx-auto max-w-screen-xl px-4 pb-8 pt-16 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-md">
          ...
          <form className="mt-6">
            <div className="relative max-w-lg">
              ...
              <button className="absolute end-1 top-1/2 -translate-y-1/2 rounded-full bg-gradient-to-r from-[#F28500] to-[#FFBF00] px-5 py-3 text-sm font-poppins font-medium text-white transition hover:bg-blue-700">
                Subscribe
              </button>
            </div>
          </form>
        ...
        <div className="mt-16 border-t border-gray-100 pt-8">
          <p className="text-center text-xs/relaxed text-gray-300 font-poppins">
            ...
            <br />
            Created with
            <span className="mx-1">Passion</span>
            by
            <a
              href="#"
              className="text-orange-500 ml-1 underline transition hover:text-gray-700/75"
            >
              Sahil Ahmed
            </a>
            .
