  ...
  return (
    <div className='px-10 py-10 my-10 space-y-8'>
        <div className='flex flex-col items-center justify-center gap-8 p-10'>
            <h2 className='text-zinc-800 dark:text-white font-poppins text-4xl md:text-5xl text-start font-semibold leading-[48px] md:leading-[62px]'>
                Code
                <span className="bg-gradient-to-r from-[#F28500] to-[#FFBF00] inline-block text-transparent bg-clip-text mx-2">smarter</span>
                than ever.
            </h2>
            <p className='text-base md:text-lg font-poppins text-gray-800 dark:text-gray-100'>
